...
(105, 13, 'mohammad', 'mh.karimi179@gmail.com', '2023-02-09 23:50:40', 269, 288669, 'پرداخت از طریق بانک', 'تکمیل پرداخت', 'در حال ارسال', '1676015440');
...
(142, 'پرتغال درجه1', 'ahmadi', 'kartoni', '', '35000', 49992, 'product-featured-142.jpeg', '', '', '', '', 34, 1, 1, 90),
...
(1, 4, 4, 5, 5, 7, 4, 8, 'محصولات ویژه', '', '', 1, 1, 1);
